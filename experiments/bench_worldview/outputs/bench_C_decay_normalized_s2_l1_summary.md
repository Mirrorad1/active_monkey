...
World: C  Mechanism: decay  Convention: normalized
...
|-------|-----------|-------------|------|---------|----------------|------|--------------|-----------------|
| C | decay | 7 | 0 | 1.1632 | 1.1595 | 0.0038 | 0 | 0 |
| C | decay | 7 | 1 | 1.1845 | 1.2040 | -0.0195 | 0 | 0 |

## Aggregate

- Mean plateau: 1.1739 nats
- Mean final surprise: 1.1817 nats
- Mean drop: -0.0079 nats
