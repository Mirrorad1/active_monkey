...
World: C  Mechanism: random_accept  Convention: normalized
...
|-------|-----------|-------------|------|---------|----------------|------|--------------|-----------------|
| C | random_accept | 7 | 0 | 1.2104 | 0.3156 | 0.8948 | 2 | 2 |
| C | random_accept | 7 | 1 | 1.2247 | 0.2134 | 1.0114 | 3 | 2 |

## Aggregate

- Mean plateau: 1.2176 nats
- Mean final surprise: 0.2645 nats
- Mean drop: 0.9531 nats
