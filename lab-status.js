...
window.AM_LAB_STATUS = {
  ...
  directions: [
    { name: "identity-n4-crack", state: "active (chapter synthesis next — consolidation-grade, sanctioned; then the closing CONSULT and the loop holds)", latest: "Exp 184 (exploratory squeeze map) + Exp 183 addendum (seed-229 autopsy)", next: "ON RESUMPTION — Part-3 classification of the candidate sets (is any candidate a REAL crack after the class-D dissolution check?), then rung-4 fresh-seed confirmation" },
