...
window.AM_LAB_STATUS = {
  latest_exp: { n: 202, title: "N5 the INTERFERENCE-COMPETITION escape: forcing real frequency-dependent competition on a DEPLETING band (id-order confound NEUTRALISED by shuffle) does NOT cross the valley — the costed precision-organ is ACTIVELY SUPPRESSED below the founder; the primitive-sensor ceiling is now MAXIMALLY GENERAL across FOUR distinct regimes", tag: "NEGATIVE" },
  tally: { total: 202, positive: 113, negative: 57, mixed: 28, breakthroughs: 7 },
  directions: [
    ...
    { name: "population-ecology", state: "active", latest: "Exp 202 (NEGATIVE — interference-competition escape FAILED; COMPETE 0.028 < 0.10 founder at healthy pops; strip=1.00; competition SUPPRESSES organ; ceiling GENERAL across 4 regimes: 199+200+201+202; L24)", next: "Exp 203 verdict (POSITIVE_GRADIENT iff h*>0.30 ∧ resident slope>0 in ≥7/8 seeds ∧ no collapse/confound, in some ecology; else NEGATIVE_GRADIENT)" },
