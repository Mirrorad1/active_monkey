...
window.AM_LAB_STATUS = {
  latest_exp: { n: 188, title: "the human's single-regulated-controller retest (pre-registered 3ecfc77; the Exp-187 question renumbered per the append-only log): POSITIVE — YES, one online regulated controller (REG-TB: no oracle, no cell-specific tuning) passes BOTH bars in 9/9 confirmed crack cells — at EXACT defense parity with the constant INT-C2900 (identical 6/8 per cell, same two failing seeds), confirming the single-stretch ambiguity bound: at fixed-L geometry, regulation matches the right clock and nothing yet distinguishes judgment from it", tag: "POSITIVE" },
  tally: { total: 188, positive: 109, negative: 48, mixed: 27, breakthroughs: 5 },
  directions: [
    { name: "identity-n4-crack", state: "active (rung 6 = Exp 189, the variable-L separation test, re-opened on the human's word \"a\" 2026-06-12; previously closed-positive — 9 confirmed cells; closed constructively on the continuity clock; the regulated-controller question answered at exact parity; chapter synthesis committed)", latest: "Exp 184 (exploratory squeeze map) + Exp 183 addendum (seed-229 autopsy)", next: "ON RESUMPTION — Part-3 classification of the candidate sets (is any candidate a REAL crack after the class-D dissolution check?), then rung-4 fresh-seed confirmation" },
