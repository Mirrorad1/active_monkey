...
window.AM_LAB_STATUS = {
  ...
  directions: [
    { name: "identity-n4-crack", state: "active (rung 3 = Part-3 classification, authorized by the human's \"continue\" 2026-06-12; after it the loop posts the crack-or-dissolved consult and HOLDS — rung-4 confirmation needs its own word)", latest: "Exp 184 (exploratory squeeze map) + Exp 183 addendum (seed-229 autopsy)", next: "ON RESUMPTION — Part-3 classification of the candidate sets (is any candidate a REAL crack after the class-D dissolution check?), then rung-4 fresh-seed confirmation" },
