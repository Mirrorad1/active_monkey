...
window.AM_LAB_STATUS = {
  latest_exp: { n: 201, title: "N5 the INCREASING-RETURNS escape: forcing precision to TRACK a moving food band does NOT cross the valley either — the primitive-sensor ceiling is general across avoidance, foraging AND increasing-returns geometry; \"increasing-returns geometry\" did not yield increasing RETURNS", tag: "NEGATIVE" },
  tally: { total: 201, positive: 113, negative: 56, mixed: 28, breakthroughs: 7 },
  directions: [
    ...
    { name: "population-ecology", state: "active", latest: "Exp 201 (NEGATIVE/NEW INSIGHT — WALL 3/3 blind-verified; increasing-returns escape FAILED; precision benefit CONCAVE; NO GOLDILOCKS GRADIENT third time; ceiling general: avoidance+foraging+increasing-returns; L23)", next: "AWAITING HUMAN STEER — (a) real frequency dependence/interference competition; (b) different N5 axis (sympatric divergence/mate choice); (c) re-run Exp 198 with L21 fix; (d) neural Bθ; (e) redirect" },
