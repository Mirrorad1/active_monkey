...
window.AM_LAB_STATUS = {
  ...
  directions: [
    ...
    { name: "identity-n4-crack", state: "halted (PAUSED on the human's explicit word, 2026-06-12, \"once you're done with this experiment, pause\" — rungs 1–2 complete; resumes only on the next explicit direction in loop/IDEAS.md)", latest: "Exp 184 (exploratory squeeze map) + Exp 183 addendum (seed-229 autopsy)", next: "ON RESUMPTION — Part-3 classification of the candidate sets (is any candidate a REAL crack after the class-D dissolution check?), then rung-4 fresh-seed confirmation" },
