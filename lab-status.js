...
window.AM_LAB_STATUS = {
  ...
  directions: [
    { name: "identity-n4-crack", state: "active (rung 1 done — autopsy mechanism pinned; Exp 184 next)", latest: "Exp 183 addendum (seed-229 autopsy, 2026-06-12)", next: "Exp 184 exploratory squeeze map — is a robust no-fixed-H regime constructible from the dose-ledger mechanism (route 2), or does any cell empty the fixed-H interval (route 1)?" },
