...
window.AM_LAB_STATUS = {
  ...
  directions: [
    { name: "identity-n4", state: "active (rung 3 — design iteration)", latest: "Exp 180", next: "Exp 181 — rung 3, the commitment controller (full predeclaration next iteration): arms (a) N4-less, (b) N4 (value-update weight regulated by monitor mismatch), (c) fixed-inertia constant sweep (the universal-constant kill test); falsifiers per the ladder — (i) N4 beats (a) on recovery, (ii) N4 preserves sustained-evidence revision within declared tolerance, (iii) NO constant matches N4 on both; plus a direct v-dynamics control-validity check; FRESH seeds 210+" },
