...
**STATUS.** state: active (opened 2026-06-15, human's word; active-sensing line closed-negative) · latest: none yet (Exp 212 = rung 1) · depends-on: the Exp 210–211 active-sensing/hidden-mode substrate (probe_policy, byte-identity guards, cap-250 garden, benefit-ceiling instrumentation, Evolvability Preflight) · reusable: yes · why: makes the local-gradient wall the object of study — landscape assay + heavy-tail / standing-variation / bundle preflights, reusable for any closed-negative trait · next-falsifiable: Exp 212 — landscape assay: does any larger info-sampling config yield a bulk-fitter region, or is it flat/negative once cost+controls are honest?
