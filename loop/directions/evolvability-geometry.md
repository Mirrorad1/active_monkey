...
**STATUS.** state: active (CONVERGING-NEGATIVE — awaiting steer) · latest: Exp 213 GEOMETRY_INDEPENDENT_WALL (blind-verified): affordance audit (SMOOTH graded vs DISCRETE high-stakes, matched cost) — NO affordance locally evolvable (2–3/8 wins), discrete not steeper than smooth ⇒ payoff geometry doesn't change evolvability; Exp 212 NO_HIGHER_REGION (no valley) · depends-on: Exp 204/210–211 substrates + Evolvability Preflight · reusable: yes · why: landscape + affordance-audit instruments classify whether a trait/geometry has a reachable fitter region · next-falsifiable: DECISION POINT — both rungs say the blocker is benefit MAGNITUDE not geometry; one more steeper-affordance probe or CLOSE (benefit-magnitude wall, shape-independent).
