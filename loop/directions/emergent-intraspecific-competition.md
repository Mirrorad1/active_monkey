...
**STATUS.** state: active · R2 follow-up DONE (Exp 265, POSITIVE-SINGLE): REFUGES decouple intraspecific aggression from predation — refuge aggr@end flat ~0.77-0.85 across attack_a 0.01-0.07 (0/10 extinct, decoupled); refuge-free aggr@end declines 0.734->0.396 as predation rises + N/K falls (4/10 extinct at attack_a=0.07, coupled). Mechanistic explanation of R2's orthogonality: refuge patches crowd locally regardless of global predation. R1 (263): aggression EMERGES under scarcity, clears the local-gradient wall. R2 (264): co-emerges w/ co-evolving predator but ORTHOGONAL (no buffering). substrate: gated enable_contest+aggr+lineage on ecology/patchmosaic.py, byte-identical OFF · next: R3 cannibalism -> emergent ROLES (what is a predator/prey)
