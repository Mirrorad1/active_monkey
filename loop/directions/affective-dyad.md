...
**STATUS.** state: active (M4a; FIRST ignition found — next is reliability/ratchet, NOT closure) · latest: Exp 216 — ignition-envelope diagnostic, POSITIVE/NEW INSIGHT (blind-verified): the direct-head dyad LEARNS to earn POS under a generous-but-HONEST scaffold — first ignition after four 0/8 halts. Decomposed: policy-only 1.0, update-only 0.83 at K=U+lr+600 vs 0.0 at aliased K=4, closed-loop 1/4 ignite (seed20 POS 0.10→0.34); Exp215's wall was a CONJUNCTION, binding remainder = exploration cold-start · depends-on: affect_spec/affect_agent + tests · reusable: yes · why: existence-result redirects M4a to path-found · next-falsifiable: Exp 217 — 1f: break the cold-start (optimistic init / ε-greedy / curriculum) then ratchet toward realism — reliable ignition (≥2/4)?
