...
**STATUS.** state: active (M4a; RELIABLE ignition on the generous scaffold — next is ratchet-to-realism, NOT closure) · latest: Exp 217 — cold-start break, POSITIVE/NEW INSIGHT (blind-verified): honest exploration turns Exp 216's fragile 1/4 into a RELIABLE 7/8. optimism (+2.0 uniform on the POS prior; HONEST — equal at correct & wrong cells) → 7/8, mean-last 0.44 vs 0.20 chance; ε-greedy 5/8; control 2/8 reproduces Exp 216. The exploration cold-start WAS the binding remainder; an honest aid breaks it. Still GENEROUS (K=U=6, γ8, 300t); realistic K=4/100t deferred · depends-on: affect_spec/affect_agent + tests · reusable: yes · why: first reliable dyad (scaffold-dependent) · next-falsifiable: Exp 218 — 1g: ratchet γ/K/turns toward realism — minimal scaffold for reliable (≥6/8) ignition?
