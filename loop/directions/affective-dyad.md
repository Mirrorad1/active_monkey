...
**STATUS.** state: active (M4a; genuine discrimination is REAL but only ~half-reliable — no reliable regime yet) · latest: Exp 219 — discrimination, PARTIAL / NEW INSIGHT (blind-verified): an honest constant-UNFAKEABLE probe (genuine = ≥3/6 codes right AND last>1/3). Best K=4 = 5/8; NO cell ≥6/8 (K=6 controls 4–5/8). KEY: csel & POS DECOUPLE — SHORT SESSION blocks LEARNING (chance csel at 100t), LOW PRECISION blocks EXPLOITATION (γ1 learns csel 0.54 but won't act); K=4 ≈ K=6 ⇒ capacity NOT the blocker. Tempers 217/218: anchor's lenient 7/8 = 4/8 GENUINE; N=8 ⇒ no cell ranking · depends-on: affect_spec/affect_agent · reusable: yes · why: honest metric + clean blocker split · next-falsifiable: Exp 220 — 1i: a PRECISION SCHEDULE (anneal γ) + bigger N → reliable genuine discrimination at K=4?
