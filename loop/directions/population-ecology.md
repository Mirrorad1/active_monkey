...
**STATUS.** state: active · latest: Exp 202 (NEGATIVE — interference-competition escape FAILED; COMPETE 0.028 < 0.10 founder at healthy pops; strip=1.00; competition SUPPRESSES organ; ceiling GENERAL across 4 regimes: 199+200+201+202; L24) · depends-on: ecology/ substrate (Exp 194–202) · reusable: ecology engine + shuffle_creature_order + strip-gate · why: N5 pop-ecology = ladder-N7 territory · sub-arc: SENSE-EVOLUTION (Exp 203–206, human steer 2026-06-13) — reframed to "what makes a costed sense EVOLVABLE not gifted"; reusable ecology/sense_axis.py; Exp 203 = SELECTION-GRADIENT AUDIT (predicts NEGATIVE_GRADIENT: B(h)≫0 but resident slope ≤0), bridges 204 residue / 205 barcode-niches / 206 sensor-controller STAGED behind a post-203 consult; gated freeze_thermosense + founder_mix · next-falsifiable: Exp 203 verdict (POSITIVE_GRADIENT iff h*>0.30 ∧ resident slope>0 in ≥7/8 seeds ∧ no collapse/confound, in some ecology; else NEGATIVE_GRADIENT)
