...
**STATUS.** state: active · latest: Exp 240 CANDIDATE first wall-escape at equilibrium (caveats: directional/runaway — speed-1.1 has no finite carrying capacity, commons tragedy once common; one regime; robustness untested) · next-falsifiable: characterize the runaway — does cost EVER bound speed to a stable ESS at finite speed? Replicate invasion across ≥2 other cost regimes before claiming substrate-specificity of the wall.
