...
def compose(direction: str, persona: str, idea: str | None) -> str:
    ...
    parts += [
        ...
        "honest-caveat line. loop/METHODOLOGY.md is the ADVISORY heuristics layer",
        "(design-time questions before predeclaring; evaluation + generalizability checks",
        "before logging/grading; VALIDATION stays binding where they differ). Check",
        "loop/IDEAS.md at every wake; human entries outrank",
