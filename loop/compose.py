...
def compose(direction: str, persona: str, idea: str | None) -> str:
    ...
    parts += [
        ...
        "before every experiment commit. Check loop/IDEAS.md at every wake; human",
        "entries outrank your queue. One experiment per iteration on a short",
        "~5-minute cadence; if mid-task, continue across wakes. Keep responses",
        "lightweight. When insight flattens for ~3 iterations, say so and gently",
        "suggest a direction switch or a natural stop.",
