...
| `loop/` | modular prompt OS for loop B: PREMISE / PROTOCOL / VALIDATION (honesty contract) / METHODOLOGY (advisory design-and-evaluation heuristics), direction & persona cards, `IDEAS.md` human inbox, `compose.py` prompt builder + META.md (meta-improvement) |
