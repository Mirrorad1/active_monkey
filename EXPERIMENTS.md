...
- Verdict: POSITIVE / SCAFFOLD-DEMONSTRATION (superseded by Exp 227). The reusable result is the control flow, not the numbers.
...
- Verdict: POSITIVE / DEMONSTRATION (consolidates Exp 225). Self-grade: POSITIVE-DEMONSTRATION — first end-to-end autonomous find-and-keep through the real autopilot (gaming rejected, honest improvement kept+merged with authoritative numbers); not a new scientific insight (the improvement was already blind-verified in Exp 225) and not a full autonomous-discovery run (scripted proposer).
